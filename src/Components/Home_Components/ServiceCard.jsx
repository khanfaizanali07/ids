...
const ServiceCard = ({item}) => {
  ...
  return (
    <>
    <div className="card border-2 h-[350px] bg-base-100 shadow-xl cursor-pointer flex justify-center items-end overflow-hidden transition ease-in-out duration-1000 hover:transition hover:scale-110 hover:ease-in-out hover:duration-700  mb-[50px] ms-[50px] md:w-[300px]  ">
