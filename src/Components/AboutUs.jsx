    ...
    <BreadCrumb>
      ...
      <div className="lg:flex lg:justify-center lg:flex-row md:flex-row md:items-center bg-[#336298] w-full lg:mt-20 lg:pt-20 lg:pb-20 md:flex sm:flex sm:flex-col sm:justify-center sm:items-center sm:pb-26 flex justify-center items-center flex-col pb-40">
          ...
          <div className="w-1/2">
            ...
            <div className="card w-30 lg:w-60 md:w-40 bg-primary text-primary-content absolute lg:mt-[-160px] lg:ml-[-80px] md:mt-[-100px] md:ml-[-8px] mt-4 mr-20">
            <div className="card-body">
              <h2 className="card-title text-xl lg:text-8xl md:text-4xl">05<p className="lg:text-lg md:text-sm text-sm">Years of Experience in IT</p></h2>
            </div>
          </div>
          </div>
        </div>
