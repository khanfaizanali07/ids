...
const CardComponent = ({cardDetails}) => {
  ...
  return (
   <>
    <div className="card lg:w-[345px] shadow-2xl rounded-lg py-[10px] md:py-[10px] lg:py-[30px] px-[10px] md:px-[10px] lg:px-[25px] bg-slate-100 hover:bg-black hover:bg-opacity-[0.5] hover:text-white font-nunito transition-all duration-700 lg:block  ">
    <div>
