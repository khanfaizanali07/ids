    ...
    <div className="px-16 flex justify-center mb-[-102px] mt-8">
      <div style={{backgroundImage : `url(${backgroundImg})`}} className=" bg-cover rounded-xl bg-center relative bg-no-repeat lg:h-[200px] lg:w-full flex flex-wrap h-auto md:w-[600px] lg:flex justify-evenly items-center gap-4">
            ...
            <div className="text-center pt-8">
                <b className="text-xl lg:text-2xl">Obtain further information <br/> by contacting with our <br/> experienced IT staffs.</b>
                <p className="text-xs mt-2">Contact to require a detailed analysis and assessment of your plan.</p>
            </div>
            ...
            <div className="text-center">
               {numbers.map((number, index) => <a key= {index} href={number.href} className="text-lg lg:text-2xl"><b className="text-white inline transition-all duration-600 hover:text-black">{number.phone}</b><FiPhone className="inline text-sm text-white ml-2"/><br/></a>)}
            </div>
      </div>
      </div>
  )
