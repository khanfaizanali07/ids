...
const CarousalTwo = () => {
  ...
  <Swiper
        ...
        >
          <SwiperSlide>
        <div
              className={`${baseClasses} bg-center bg-[url('./assets/test/bg2.jpg')]  bg-no-repeat`}
            >
          ...
          <SwiperSlide>
            <div
              className={`${baseClasses} bg-center bg-[url('./assets/test/bg31.jpg')] bg-no-repeat`}
            >
          ...
          <SwiperSlide>
            <div
              className={`${baseClasses} bg-center  bg-[url('./assets/test/bg4.jpg')] bg-no-repeat`}
            >
