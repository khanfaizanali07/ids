...
const ServiceCard = ({item}) => {
  ...
  return (
    ...
    <figure style={{backgroundImage: `url(${item.bgImage})`}} className={`bg-[url(./assets/Images/Serviceimage-2.jpg)] w-[200px] h-full md:w-[300px] bg-no-repeat bg-center p-[0px] hover:duration-300    `} onMouseOver={handleMouseEnter} onMouseOut={handleMouseLeave}>
