...
const PortalCard = ({portal}) => {
  return (
    <div>
        <div className="sm:w-80 w-40 hover:bg-[#336298] text-black hover:text-white border-2 border-[#e7e7e7] transition-all hover:-translate-y-6 duration-500 hover:ease-in-out bg-white">
