...
const Careers = () => {
  return (
    <div>
      ...
      <div className="flex lg:flex-row md:justify-center md:items-center w-full bg-[#336298] py-20 px-16 flex-wrap flex-col">
        <div className="lg:w-1/2 w-full">
          <h1 className="md:text-4xl text-xl font-bold text-[#9AB2CC]"><span className="bg-gradient-to-r from-blue-300 to-red-400 bg-clip-text text-transparent">iDiligence</span> is comitted to helping you reach to your potential.</h1>
          <p className="md:text-xl text-md text-white pt-6">iDiligence Solutions Pvt. Ltd. is always in search of the best talent who not only become part of our iDS team but also enhances its values. As a member, our employee is not only an asset to our company but a “Diligent” who makes a difference to himself, the company and the clients. If you are charged up to grow along with us and considers yourself a good & continuous learner, then you are at the right place.</p>
        </div>
